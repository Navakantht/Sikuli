...
public class TestngListener implements ITestListener {
	...
	public String kirwaFile=dirPath+"\\KIRWA.properties";
	public String kirwalogopath=dirPath+"\\src\\test\\resources\\images\\Pearson.PNG";
	...
	public TestngListener() throws IOException 
	{
		...
		sTestngReports= new File(dirPath+"//..//Reports//TestNGReports");
		sPdfReports = new File(dirPath+"//..//Reports//PDFReports");
